  ...
  return (
    ...
    <Paper classes={{ root: styles.root }}>
      ...
      <TextField 
          ...
          {...register('fullName',{required:'Укажите полное имя'})} className={styles.field} label="Full name" fullWidth />
      <TextField 
      ...
      <TextField 
          ...
          type="password"
          {...register('password',{required:'Укажите пароль'})} className={styles.field} label="Password" fullWidth />
